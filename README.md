...
Current version 1.6.0 features:

- Configurable speed ramp at start-up with the following parameters: start-speed, end-speed and speed-step
- Support for temperature measurement for MOSFETs and over-heating protection
...
- [AVR<sup>®</sup> EB Product Page](https://www.microchip.com/en-us/products/microcontrollers-and-microprocessors/8-bit-mcus/avr-mcus/avr-eb?utm_source=GitHub&utm_medium=TextLink&utm_campaign=MCU8_AVR-EB&utm_content=avr-motor-control-high-speed-github&utm_bu=MCU08)
- [AVR<sup>®</sup> EB Code Examples](https://mplab-discover.microchip.com/v2?dsl=avr16eb32)
- [AVR<sup>®</sup> DA Product Page](https://www.microchip.com/wwwproducts/en/AVR128DA48?utm_source=GitHub&utm_medium=TextLink&utm_campaign=MCU8_AVR-DA&utm_content=avr-motor-control-high-speed-github&utm_bu=MCU08)
...
- [MPLAB® X IDE v6.35 or newer](https://www.microchip.com/en-us/tools-resources/develop/mplab-x-ide?utm_source=GitHub&utm_medium=TextLink&utm_campaign=MCU8_AVR-EB&utm_content=avr-motor-control-high-speed-github&utm_bu=MCU08)
- [MPLAB Code Configurator (MCC) v5.9.0 or newer](https://www.microchip.com/en-us/tools-resources/configure/mplab-code-configurator?utm_source=GitHub&utm_medium=TextLink&utm_campaign=MCU8_AVR-EB&utm_content=avr-motor-control-high-speed-github&utm_bu=MCU08)
- [MPLAB® Tools for VS Code® v1.2.5 or newer](https://www.microchip.com/en-us/tools-resources/develop/mplab-tools-vs-code?utm_source=GitHub&utm_medium=TextLink&utm_campaign=MCU8_AVR-EB&utm_content=avr-motor-control-high-speed-github&utm_bu=MCU08)
- [MPLAB® XC8 compiler v4.00 or newer](https://www.microchip.com/en-us/tools-resources/develop/mplab-xc-compilers?utm_source=GitHub&utm_medium=TextLink&utm_campaign=MCU8_AVR-EB&utm_content=avr-motor-control-high-speed-github&utm_bu=MCU08)
...
- [AVR<sup>®</sup> EB Curiosity Nano](https://www.microchip.com/en-us/development-tool/EV73J36A?utm_source=GitHub&utm_medium=TextLink&utm_campaign=MCU8_AVR-EB&utm_content=avr-motor-control-high-speed-github&utm_bu=MCU08)
- [AVR<sup>®</sup> DA Curiosity Nano](https://www.microchip.com/en-us/development-tool/dm164151?utm_source=GitHub&utm_medium=TextLink&utm_campaign=MCU8_AVR-EB&utm_content=avr-motor-control-high-speed-github&utm_bu=MCU08)
- [AVR<sup>®</sup> ATmega Curiosity Nano](https://www.microchip.com/en-us/development-tool/DM320115)
- [Multi-Phase Power Board (MPPB)](https://www.microchip.com/en-us/development-tool/EV35Z86A?utm_source=GitHub&utm_medium=TextLink&utm_campaign=MCU8_AVR-EB&utm_content=avr-motor-control-high-speed-github&utm_bu=MCU08)
...
- For the development and testing of this demo, the following motors were used:
  ...
  - Hacker A10 KV 2900
  - A2212 KV 2200
  - 130K RPM 12V low-cost air-blower motor
  - 110K RPM 220V one-phase air-blower motor
...
|Temperature Sensor             |Pin 19 - PC0                    |Pin 45 - PD5                     |Pin 48 - PD5                     |Pin 31                         |
...
<br>The following configuration settings (apart from the default values) are needed to run the demo in the Trapezoidal Sensorless mode with the ACT57BLF02 motor,the SZSPEED 2207 2500KV drone motor and the one-phase air blower motor.
...
#define MOTOR_RAMP_END_SPEED            (4000.0)     /* e-RPM */
...
#define HALL_MISALIGNMENT_CW            (10.0)       /* Hall misalignment 0.0 ... 90.0 electrical degrees */
...
/* Motor-specific settings */
/* A2207-2500KV:  supply 17V, 3A limit */
#define MOTOR_PHASE_ADVANCE             (10.0)       /* Phase advance 0.0 ... 30.0 electrical degrees */
#define MOTOR_STARTUP_CURRENT           (10000.0)    /* mA - Initial alignment current pulse may be higher than overcurrent protection */
#define MOTOR_RPP                       (0.1)        /* ohm - Motor resistance measured phase-to-phase */
#define MOTOR_OPEN_LOOP_RAMP            (0.0004)     /* Amplitude ramp steepness: step size per millisecond 0.00004 ... 1.0 */
#define MOTOR_ALIGNMENT_DURATION        (5)          /* ms */
#define MOTOR_STARTUP_TIME              (100)        /* ms - Delay until commands (POT or PWM-in) are accepted; a value of '-1' causes commands to be ignored */
#define MOTOR_RAMP_START_SPEED          (4000.0)     /* e-RPM - e-RPM - Specifies the initial speed - minimum value is 100 e-RPM */
#define MOTOR_RAMP_END_SPEED            (15000.0)    /* e-RPM */
#define MOTOR_RAMP_STEP_SPEED           (5)          /* e-RPM */
#define HALL_ENABLED                    false        /* Setting to 'true' enables the Hall synchronization, while setting to 'false' enables the BEMF synchronization */
#define HALL_MISALIGNMENT_CW            (0.0)        /* Hall misalignment 0.0 ... 90.0 electrical degrees */
#define HALL_MISALIGNMENT_CCW           (0.0)        /* Hall misalignment 0.0 ... 90.0 electrical degrees */
#define HALL_INVERTED                   false        /* Sets the Hall pins polarity - 'true' for sensors active in '0' and 'false' for sensors active in '1' */ 
...
<br><h3> Air-Blower One-Phase Motor Configuration Settings </h3>
...
#define MOTOR_RPP                       (10.0)       /* ohm - Motor resistance measured phase-to-phase */
#define MOTOR_OPEN_LOOP_RAMP            (0.0004)     /* Amplitude ramp steepness: step size per millisecond 0.00004 ... 1.0 */
#define MOTOR_ALIGNMENT_DURATION        (100)        /* ms */
#define MOTOR_STARTUP_TIME              (100)        /* ms - Delay until commands (POT or PWM-in) are accepted; a value of '-1' causes commands to be ignored */
#define MOTOR_RAMP_START_SPEED          (7000.0)     /* e-RPM - e-RPM - Specifies the initial speed - minimum value is 100 e-RPM */
#define MOTOR_RAMP_END_SPEED            (7500.0)     /* e-RPM */
#define MOTOR_RAMP_STEP_SPEED           (5)          /* e-RPM */
#define HALL_ENABLED                    false        /* Setting to 'true' enables the Hall synchronization, while setting to 'false' enables the BEMF synchronization */
#define HALL_MISALIGNMENT_CW            (0.0)        /* Hall misalignment 0.0 ... 90.0 electrical degrees */
#define HALL_MISALIGNMENT_CCW           (0.0)        /* Hall misalignment 0.0 ... 90.0 electrical degrees */
...
/* Speed regulation specific settings */
#define REGULATOR_SPEED_EN              true         /* Setting to 'true' enables speed control in Closed Loop, setting to 'false' enables amplitude control in Open Loop */
#define REGULATOR_MAX_SPEED             (70000.0)    /* e-RPM target speed for 100% command */
#define REGULATOR_MIN_SPEED             (30000.0)    /* e-RPM target speed for   0% command */
#define REGULATOR_PI_KP                 (1.0)        /* PI speed control loop proportional coefficient */
...
#define DRIVE_FORCED                    false        /* Setting to 'true' runs the motor without BEMF sensing, only blind drive and no rotor synchronization, which could overheat the motor */
#define SINGLE_PULSE_MODE               true         /* Setting to 'true' enables the single pulse drive method, while setting to 'false' enables the PWM modulation drive method */
#define PWM_TO_SP_THRESHOLD             (60000.0)    /* e-RPM  PWM -> Single Pulse transition */
#define SP_TO_PWM_THRESHOLD             (50000.0)    /* e-RPM  Single Pulse -> PWM transition */
#define STALL_DETECTION_THRESHOLD       (50)         /* Stall detection tolerance: a higher number leads to more tolerance to perturbances, but slower detection */
#define STALL_DETECTION_ENABLED         true         /* Setting to 'false' disables the stall detection mechanism */
...
The three motor demo code examples support both MPLAB X IDE and Visual Studio Code (VS Code) for programming the hardware. The processes to program the boards using the two tools is explained below.
...
<br> The serial interface provides information about the remote controller PWM input, potentiometer value, voltage bus value, temperature value, motor current value, electrical rotations per minute (RPM) value and motor running state (ON/OFF).
...
<br>The application measures both signals from the PWM-RC and on-board potentiometer, but the PWM-RC has priority over the potentiometer in controlling the motor.
...
<br>• <b>`ADC_TEMP_TRIP`</b> - Sets the ADC trip level in case of an overtemperature protection, expressed in degrees Celsius
...
<br>• <b>`TEMP_SENSOR_K1`</b> - Temperature sensor constant for sensor MCP9701. For more information check [`MCP9701`](https://www.microchip.com/en-us/product/mcp9701)
<br>• <b>`TEMP_SENSOR_K2`</b> - Temperature sensor constant for sensor MCP9701. For more information check [`MCP9701`](https://www.microchip.com/en-us/product/mcp9701)
...
|          Three Phase Motors                                            |            One Phase Motors                                                |
|:----------------------------------------------------------------------:|:--------------------------------------------------------------------------:|
| <img src="images/drive_sequence_pwm.png">                              | <img src="images/drive_sequence_pwm_1ph.png">                              |
...
|          Three Phase Motors                                            |            One Phase Motors                                                |
|:----------------------------------------------------------------------:|:--------------------------------------------------------------------------:|
| <img src="images/drive_sequence_sp.png">                               | <img src="images/drive_sequence_sp_1ph.png">                               |
...
|          Three Phase Motors                                             |            One Phase Motors                                                 |
|:-----------------------------------------------------------------------:|:---------------------------------------------------------------------------:|
| <img src="images/pwm_to_sp_cross.png">                                  | <img src="images/pwm_to_sp_cross_1ph.png">                                  |
...
|          Three Phase Motors                                            |            One Phase Motors                                                |
|:----------------------------------------------------------------------:|:--------------------------------------------------------------------------:|
| <img src="images/commutation.png">                                     | <img src="images/commutation_1ph.png">                                     |
...
|:---------------------:|:-------------------------------:|:------------------:|:-----------------------:|:------------------------:|:-------:|
|ACT42BLF01             | 24V/1.9A/4 pp*/4 kRPM           |    24              |      0.20  (no load)    |       15,000             | 3-phase |
|ACT57BLF02             | 24V/7.8A/4 pp/3 kRPM            |    24              |      0.50  (no load)    |       12,000             | 3-phase |
|Hurst DMA0002024C1010  | 24V/4A/5 pp*/3 kRPM             |    24              |      0.14  (no load)    |       15,000             | 3-phase |
|Air Blower             | 12V/12.5A/1 pp/130 kRPM         |    12              |      11.0  (own fan)    |      120,000             | 3-phase |
|A2207 KV2500           | 16.8V/3A/7 pp/42 kRPM           |    16              |      2.2   (no load)    |      250,000             | 3-phase |
|A2212 KV2200           | 12V/3A/6 pp/26 kRPM             |    12              |      2.5   (no load)    |      140,000             | 3-phase |
|A10 KV2900             | 8.4V/6 pp/23 kRPM               |     9              |      1.5   (no load)    |      120,000             | 3-phase |
|Air Blower One Phase   | 220V/0.5A/2 pp/ 110 kRPM        |    50              |      0.12  (own fan)    |       80,000             | 1-phase |
